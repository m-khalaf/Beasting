    ...
    <div class={classString} id={title} >
      <div className="card" style={{ height: "70vh", width: "50vh" }} >
        ...
        <div className="card-body" style={{ height: "40%", width: "100%", display: "flex", flexDirection: "column", alignItems: "center", alignContent: "center", alignSelf: "center" }}>
          ...
          <a href="#" id={title} className="btn btn-primary third-space" style={{ height: "30%" }} onMouseEnter={(e) => { e.target.style.backgroundColor = "red"; e.target.transform = "scale(0.95)"; }} onMouseLeave={(e) => { e.target.style.size = "1"; e.target.style.backgroundColor = "#0d6efd"}}>
            Select Plan
          </a>
        </div>
      </div>
